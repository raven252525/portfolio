        ...
        <RevealOnScroll>
            <div className="max-w-5xl mx-auto px-4 ">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 
                    hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition-all">
                        <h3 className="text-xl font-bold mb-2"> Mock E-Commerce</h3>
                        <p className="text-gray-400 mb-4">A Mock-up of a Tech E-Commerce site, in order to create a dynamic and responsive web application with caching
                        capabilities, along with API fetching, capable of calculating costs, and search actions</p>
                        <div>
                            {["Node.js","React", "Next.js", "MongoDB", "TailwindCSS"].map((skill, key) => (
                        ...
                        <div className="flex justify-between items-center my-4">
                            <a className="text-blue-400 hover:text-blue-300 transition-colors"
                            href="https://my-mock-e-commerce.netlify.app/"
                            target="_blank">View Project →</a>
                        </div>
                    </div>
                    ...
                    <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 
                    hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition-all">
                        <h3 className="text-xl font-bold mb-2"> Simple Shell</h3>
                        <p className="text-gray-400 mb-4"> POSIX compliant simple shell, capable of interpreting and executing shell
                        commands, running external programs, and handling built-in commands such as cd, pwd, and echo</p>
                        <div>
                            {["Git", "CMake", "Bash", "Linux", "Unit Testing", "C++"].map((skill, key) => (
                                <span key={key} className="bg-blue-500/10 text-blue-500 py-1 px-3 rounded-full
                                    text-sm hover:bg-blue-500/20 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] 
                                    transition flex md:inline-block mx-1 my-1">
                                    {skill}
                        ...
                        <div className="flex justify-between items-center my-4">
                            <a className="text-blue-400 hover:text-blue-300 transition-colors"
                            href="https://github.com/raven252525/simple-shell"
                            target="_blank">View Project →</a>
                        </div>
                    </div>
                </div>
