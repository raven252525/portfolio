    ...
    return <section id="about" className="min-h-screen flex items-center justify-center py-20">
        <RevealOnScroll>
            <div className="max-w-3xl mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-rows-2 gap-6 mt-8">
                            ...
                            <ul className="list-disc list-inside text-gray-300 space-y-2"> 
                                ...
                                <li className="text-xl">
                                    Relevant Coursework: <span className="text-lg text-gray-400 grid grid-cols-2">
                                        ...
                                        <span key={key} className="flex flex-col m-3">
                    ...
                    <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
                            <div className="flex flex-row">
                                <h3 className="text-xl font-bold mb-4"> Experience</h3> <h2 className="right-5">-my professional journey</h2>
                            </div>
                            <div className="space-y-4 text-gray-300">
                                <div>
                                    <h4 className="font-semibold"> Student Research Asisstant at Universty of California, Davis (12/2024 - present)</h4>
                                    <p className=" text-gray-400 text-sm py-2"> ● Led debugging sessions in C++ and Python, resolving tickets, and issues in CMake, GitHub version control </p>
                                    <p className=" text-gray-400 text-sm py-"> ● Educated 50+ students one on one with in depth tutorials, increasing understanding and average student engagement by
                                ...
                                <div>
                                    ...
                                    <p className=" text-gray-400 text-sm py-2"> ● Utilized custom database, Excel, and Microsoft Office to process client and employee data entry, review, and extraction,
                                    optimizing and thus reducing 20 hours of employee work weekly on averag </p>
